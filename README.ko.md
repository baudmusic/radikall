...
1. Safari로 [https://radikall-web.baudmusic.workers.dev](https://radikall-web.baudmusic.workers.dev)를 여세요.
2. 홈 화면 / 바탕화면에 저장하면 바로 사용할 수 있습니다.

### macOS

1. Safari로 [https://radikall-web.baudmusic.workers.dev](https://radikall-web.baudmusic.workers.dev)를 여세요.
2. 바탕화면에 저장하면 바로 사용할 수 있습니다.
